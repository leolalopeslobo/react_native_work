...
export default function OnboardingMainScreen({ navigation }) {
  return (
    <View style={styles.container}>
      ...
      <View style={styles.onboardButton}>
        <TouchableOpacity onPress={()=> navigation.navigate("SignInSA")} style={styles.onboardbuttonStyle}><Text style={{color:'#fff'}}>Continue</Text></TouchableOpacity>
      </View>
